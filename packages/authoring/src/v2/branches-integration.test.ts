// Seam 3: a conditional contract end to end. An authored `when` branch, its
// flat-config entry, and the messages a real ESLint Linter reports over the
// built plugin — fact, witness and because assembled into one line.
