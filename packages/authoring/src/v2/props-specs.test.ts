// Seam 1: the v2 props map compiles to props rows. Every spec-callback verb
// lands as a row field, the map is loose so a constraint-free entry throws, a
// `true` value is a type error, and props gate on a branch delta.

import { describe, expect, it } from "vitest";

import type { PropsRowV2 } from "@jsx-contracts/eslint-plugin";
...
function propsRow(build: Parameters<typeof defineContracts>[0]): PropsRowV2 {
