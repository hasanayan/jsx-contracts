...
// The condition tree and because ride along; delta verbs record forbid/require/
// extend, with extend shorthand expanded against the subject.

import { describe, expect, it } from "vitest";

import type { SlotBranchV2 } from "@jsx-contracts/eslint-plugin";
