// Seam 2 (core): the effective-vocabulary formula — base ∪ active extends −
// active forbids, extend replacing a redeclared slot, requireSlot raising a
// minimum — computed order-independently from a set of active branches.
