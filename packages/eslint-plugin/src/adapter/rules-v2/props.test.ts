// Seam 2 (rule): v2 props rows drive a real ESLint rule. Required, requires,
// excludes, requiresAnyOf and deprecated all report — base, and under a branch
// where the message carries the witness and the branch's because.
...
const buttonRows: ContractRowsV2 = [
  {
    facet: "props",
